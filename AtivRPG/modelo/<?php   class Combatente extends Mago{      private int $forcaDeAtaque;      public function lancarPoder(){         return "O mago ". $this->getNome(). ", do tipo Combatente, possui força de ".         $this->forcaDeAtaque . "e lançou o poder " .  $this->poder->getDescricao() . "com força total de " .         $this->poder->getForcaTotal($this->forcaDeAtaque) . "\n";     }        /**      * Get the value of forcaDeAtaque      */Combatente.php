...
class Combatente extends Mago{
    ...
    public function lancarPoder(){
        return "O mago ". $this->getNome(). ", do tipo Combatente, possui força de ".
        $this->forcaDeAtaque . "e lançou o poder " .  $this->poder->getDescricao() . "com força total de " .
        $this->poder->getForcaTotal($this->forcaDeAtaque) . "\n";
    }

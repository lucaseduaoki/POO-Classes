...
class Curandeiro extends Mago{
    ...
    public function lancarPoder(){
        return "O mago ". $this->getNome(). ", do tipo Curandeiro possui força de ".
        $this->forcaDeCura . "e lançou o poder " .  $this->poder->getDescricao() . "com força total de " .
        $this->poder->getForcaTotal($this->forcaDeCura) . "\n";
    }
